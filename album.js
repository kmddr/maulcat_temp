...
I felt inspired by concerts and how conquerable everything feels when I leave one. There’s been a lot of times this year where I’ve felt defeated and unresolved, whether it’s my job situation, connecting with family and friends, communicating with myself and my creative side. A lot of my time in 2022 has been spent questioning and in some cases regretting, I think putting this record together has allowed me to reach back into my excited naivety and childlike innocence with confidence. This is the music of me reconnecting with nature, people, myself, music.. rediscovering my agency and enjoying it."<br><br>
  ...
  ["Various Artists", "Maulcat Vol. 1", 3, 2022, [
    ["1","<strong>spencer hodo</strong> - vertical horizon","7:01"],
    ["2","<strong>w4fflestomp</strong> - rapid onset euphoria","3:10"],
    ["3","<strong>butterfly boy</strong> - a case of perfectionism","2:07"],
    ["4","<strong>T.R.Ash</strong> - Hugs and Kisses","2:31"],
    ["5","<strong>coniumer</strong> - freewill","5:54"],
    ["6","<strong>butterfly boy</strong> - put the needle on the record","3:57"],
    ["7","<strong>Clean Slate</strong> - Violence Majesty","3:14"],
    ["8","<strong>coniumer</strong> - fool's purpose","6:25"],
    ["9","<strong>rybbon</strong> - Rotoscope","4:01"],
    ["10","<strong>Micheal S.</strong> - Sings the Hits pt. II","7:09"],
    ["11","<strong>netbooks.WRLD</strong> - raygun","2:44"],
    ["12","<strong>CapsAdmin</strong> - queen","2:21"],
    ["13","<strong>Vale-Smith</strong> - My Pandora","2:25"],
    ["14","<strong>Monte Hills</strong> - Gotta Get","3:02"],
    ["15","<strong>Vale-Smith</strong> - Saints Session","1:53"],
    ["16","<strong>RAWINTHEVOID</strong> - eyes out","2:08"],
    ["17","<strong>spearflower</strong> - incisors dominate","2:38"],
    ["18","<strong>DOBBIE</strong> - spirit halloween twerkoff","2:29"],
    ["19","<strong>CORPSEWAX</strong> - SWEEPSTAKES","0:48"],
    ["20","<strong>DJ ARCHFIEND</strong> - depth amulet","3:14"],
    ["21","<strong>TRUMAN!</strong> - holograph logo","4:12"],
    ["22","<strong>Calcium Demo</strong> - Kiss Goodbye","2:32"],
    ["23","<strong>rat corp</strong> - Bunny Rabbit","2:39"],
    ["24","<strong>rat corp</strong> - Forbidden","2:57"],
    ["25","<strong>Melan Choir</strong> - i'm here too","5:46"],
    ["26","<strong>TRUMAN!</strong> - Renaシオン","3:44"],
    ["27","<strong>amber dregs</strong> - Lost Love","2:52"],
    ["28","<strong>zweihandr</strong> - Digital Comfort","4:25"],
  ], "Various", "Digital / CD", false, {}, [
    ["Production","Various"],
    ["Mixing/Mastering","Various<br>Syd<br>DrDuctape"],
    ["A&R","Syd"],
    ["Art","Syd<br>netbooks.WRLD"],
    ["Curator","Syd"]
  ]],
];
